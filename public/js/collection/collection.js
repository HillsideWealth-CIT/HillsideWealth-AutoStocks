...
function column_builder(){
    let columns = [
        ...
        { data : "stockdata.0.fcfroijdvic", type : "any-number" },
        { data : "setup.fcfroijdvic.3yrAvg", type : "any-number" },
        { data : "setup.fcfroijdvic.5yrAvg", type : "any-number" },
        { data : "setup.fcfroijdvic.10yrAvg", type : "any-number" },
        { data : "setup.fcfroijdvic.ttm/5yr", type : "any-number" },
        { data : "setup.fcfroijdvic.ttm/10yr", type : "any-number" },
        { data : "setup.fcfroijdvic.5stdev", type : "any-number" },
        { data : "setup.fcfroijdvic.10stdev", type : "any-number" },
