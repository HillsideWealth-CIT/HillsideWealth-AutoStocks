...
function select_dcf() {
    reset();
    let to_show = ['eps_growth_rate', 'growth_years_format', 'eps_without_nri_format', 'terminal_years_format', 'terminal_growth_rate_format', 'discount_rate_format', 'dcf_growth', 'dcf_terminal', 'dcf_fair_5y'];
    loopthrough(to_show)
}
