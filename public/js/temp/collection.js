...
function column_builder(){
    let columns = [
        ...
        { data : "setup.salesshare.3yrAvg" },
        { data : "setup.salesshare.5yrAvg" },
        { data : "setup.salesshare.10yrAvg" },
        ...
        { data : "setup.ownerEarningShare.3yrAvg" },
        { data : "setup.ownerEarningShare.5yrAvg" },
        { data : "setup.ownerEarningShare.10yrAvg" },
        ...
        { data : "setup.fcfShare.3yrAvg" },
        { data : "setup.fcfShare.5yrAvg" },
        { data : "setup.fcfShare.10yrAvg" },
        ...
        { data : "setup.pFcfRatio.5yrAvg" },
        { data : "setup.pFcfRatio.10yrAvg" },
        { data : "setup.pFcfRatio.ttm/5yr" },
        { data : "setup.pFcfRatio.ttm/10yr" },
        { data : "setup.pFcfRatio.5stdev" },
        { data : "setup.pFcfRatio.10stdev" },
