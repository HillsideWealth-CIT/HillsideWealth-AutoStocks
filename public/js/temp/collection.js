...
function column_builder(){
    let columns = [
        ...
        { data : "setup.aebitdaShare.3yrAvg" },
        { data : "setup.aebitdaShare.5yrAvg" },
        { data : "setup.aebitdaShare.10yrAvg" },
        { data : "setup.aebitdaShare.ttm/5yr" },
        { data : "setup.aebitdaShare.ttm/10yr" },
        { data : "setup.aebitdaShare.5stdev" },
        { data : "setup.aebitdaShare.10stdev" },
